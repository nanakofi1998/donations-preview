                        ...
                        <div className="p-6 max-h-[calc(100vh-20rem)] overflow-x-auto">
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                <div className="col-span-1">
                                    <label htmlFor="total_characters" className="block mb-2 text-sm font-medium text-gray-900">Verification Process</label>
                                    <select
                                        type=""
                                    ...
                                    >
                                        <option value="disabled">--Select verification process type--</option>
                                        <option value="individual">Manual</option>
                                        <option value="corporate">Automatic</option>
                                    </select>
                                </div>
                            </div>
                        </div>
