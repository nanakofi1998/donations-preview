                    ...
                    <div className="relative bg-white rounded-2xl shadow">
                        <div className="flex items-start justify-between p-4 border-b rounded-t">
                            <h3 className="text-xl font-semibold text-gray-900">
                                Select Institution Funding Type 
                            </h3>
                        </div>
                        <div className="p-6 max-h-[calc(100vh-20rem)] overflow-x-auto">
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                <div className="col-span-1">
                                    <label htmlFor="total_characters" className="block mb-2 text-sm font-medium text-gray-900">Institution Funding</label>
                                    <select
                                        type=""
                                    ...
                                    >
                                        <option value="disabled">--Select type of funding--</option>
